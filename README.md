## building appimagekit on ARM (debian 8.x jessie)

```
git clone -b appimagetool/master --single-branch --recursive https://github.com/AppImage/AppImageKit

sudo ln -s /usr/lib/arm-linux-gnueabihf /usr/lib/armv7l-linux-gnu
...
bash -ex build.sh
```
Build fails on ARM with error: faile
```
/mnt/usb/build-arm/AppImageKit/src/getsection.c:52:17: warning: passing argument 1 of ‘sprintf’ from incompatible pointer type
